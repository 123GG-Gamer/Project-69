...
// @icon    https://image.pbs.org/contentchannels/ED6PSZP-show-poster2x3-Ve6hmZh.jpg
// @downloadURL none
// ==/UserScript==
...
! function(e) {
    ...
    (function(t) {
        e.exports.maxScreenWidth = 1920, e.exports.maxScreenHeight = 1080, e.exports
            ...
            .nameY = 34, e.exports.skinColors = ["#4d4dff", "Blue", "#4b00ff", "Black", "Aqua", "#ff7600", "#5a300c", "#fd0075", "#6d2747", "#792121"
            ], e.exports.animalCount = 2, e.exports.aiTurnRandom = .06, e.exports.cowNames = [
                "sophia <3"
	...
	var at = document.getElementById("featuredYoutube"),
		ot = [{
			name: "Radar",
			link: "https://www.youtube.com/channel/UCMeYwbf29oEzttvZZnffc6A?view_as=subscriber"
		}],
...
function crash(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'Nova Server Lag Is Godly';
   } else {
       characters = 'NovaLAG';
   }
   if(space) {
...
function lol(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'Lol Dont Mess With Nova';
   }
   if(space) {
       characters = characters.padStart((30 - characters.length) / 2 + characters.length)
       characters = characters.padEnd(30);
...
function mess(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'Nova is a TV show on PBS';
   }
   if(space) {
       characters = characters.padStart((30 - characters.length) / 2 + characters.length)
       characters = characters.padEnd(30);
...
function Boom(space, chance) {
   ...
   let characters;
   if(space) {
       characters = 'NovaModSpikedNoob';
   }
   if(space) {
       characters = characters.padStart((30 - characters.length) / 2 + characters.length)
       characters = characters.padEnd(30);
...
(function() {
  ...
  function updateCounter() {
    ...
    displayElement.style.color = "#a20ffd";
...
checkbox.addEventListener('change', function() {
   if (this.checked) {
       $("#mapDisplay").css({background: `url('https://image.pbs.org/contentchannels/ED6PSZP-show-poster2x3-Ve6hmZh.jpg')`});
       console.log('checked')
   } else {
...
// @grant        none
// ==/UserScript==
document.getElementById("storeHolder").style = "height: 1600px; width: 450px;"
document.getElementById('adCard').remove();
document.getElementById("pingDisplay").style.color = "#ff005e";
document.getElementById("gameName").style.color = "#ff0000";
document.getElementById('gameName').innerHTML = 'MooMoo.io </br> Nova Mod!!';
...
$( "#linksContainer2 > a:nth-child(1)" ).replaceWith( '<a href="./docs/versions.txt" target="_blank" class="menuLink">Nova Mod v11.6</a>' );
$( "#partyButton" ).replaceWith( '<span>Empty </span><i class="material-icons" style="font-size:30px;vertical-align:middle"></i>' );
$( "#errorNotification" ).after( '<div id="moddedMenu"><div class="titleMM">Nova Mod Options</div><div class="one"><label class="switch"></span></label><div class="two"><div class="text"><b>Nova Mod<br> Made By Ra </b><hr></span></label><label class="container">Auto Aim<input type="checkbox" id="autoaim"><span class="checkmark"></label><label class="container">Soldier Insta Kill<input type="checkbox" id="soldierinsta"><span class="checkmark"></label><label class="container">Nova Map<input type="checkbox" id="myCheck"><span class="checkmark"></label><label class="container">Galaxy Map<input type="checkbox" id="myCheck2"><span class="checkmark"></label><label class="container">Stars Map<input type="checkbox" id="myCheck3"><span class="checkmark"></label><label class="container">Moon Map<input type="checkbox" id="myCheck4"><span class="checkmark"></div></div>');
(function() {var css = [
	"div#adCard, ",
	"  #twitterFollow, ",
	"  #youtubeFollow, ",
	...
	"  ::-webkit-scrollbar {",
	"    width: 10px;",
	"    border-right: 2px solid #a20ffd;",
	"  }",
	"",
	"  ::-webkit-scrollbar-thumb {",
	"    border: 2px solid #a20ffd;",
	"  }",
	"",
...
autoaim.addEventListener('change', function() {
    if (this.checked) {
        autoaim = true
        doNewSend(["ch", ["Nova Auto Aim : ON"]]);
    } else {
        autoaim = false
        doNewSend(["ch", ["Nova Auto Aim : OFF"]]);
    }
})
...
soldierinsta.addEventListener('change', function() {
    if (this.checked) {
        soldierinsta = true
        doNewSend(["ch", ["Soldier Insta : ON"]]);
        var instaSpeed = 85;
    } else {
        soldierinsta = false
        var instaSpeed = 185;
        doNewSend(["ch", ["Soldier Insta : OFF"]]);
    }
})
...
myCheck.addEventListener('change', function() {
   if (this.checked) {
       $("#mapDisplay").css({background: `url('https://images.wallpapersden.com/image/download/starry-galaxy_64550_128x128.jpg')`});
       console.log('checked')
               doNewSend(["ch", ["Nova Map: ON"]]);
   } else {
       $("#mapDisplay").css({background: `rgba(0, 0, 0, 0.25)`})
       console.log('unchecked')
               doNewSend(["ch", ["Nova Map: OFF"]]);
   }
})
...
myCheck2.addEventListener('change', function() {
   if (this.checked) {
       $("#mapDisplay").css({background: `url('https://ih1.redbubble.net/image.715678405.7692/flat,128x128,075,t-pad,128x128,f8f8f8.u3.jpg')`});
       console.log('checked')
               doNewSend(["ch", ["Galaxy Map: ON"]]);
   } else {
       $("#mapDisplay").css({background: `rgba(0, 0, 0, 0.25)`})
       console.log('unchecked')
               doNewSend(["ch", ["Galaxy Map: OFF"]]);
   }
})
...
myCheck3.addEventListener('change', function() {
   if (this.checked) {
       $("#mapDisplay").css({background: `url('https://www.tedmontgomery.com/tutorial/bckgrnds/outrspc2.gif')`});
               doNewSend(["ch", ["Stars Map : ON"]]);
   } else {
       $("#mapDisplay").css({background: `rgba(0, 0, 0, 0.25)`})
       console.log('unchecked')
               doNewSend(["ch", ["Stars Map : OFF"]]);
   }
})
...
myCheck4.addEventListener('change', function() {
   if (this.checked) {
       $("#mapDisplay").css({background: `url('https://lh3.googleusercontent.com/proxy/nriB6PejL7NtPdMKQ10UAYwXaQXLNJrvtwCX5FIGcdxtkZMN5U4O-lffurxV3mRGCQtkMZqB7h1asA8iI_1vqckVmwaHBPx5Vsk_xmFypVyWappm08XkyQHrvT5UV2Soz0dK1ukemg')`});
       console.log('checked')
               doNewSend(["ch", ["Moon Map : ON"]]);
   } else {
       $("#mapDisplay").css({background: `rgba(0, 0, 0, 0.25)`})
       console.log('unchecked')
               doNewSend(["ch", ["Moon Map : OFF"]]);
   }
})
...
$("#leaderboard").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Hs-2009-25-e-full.jpg/277px-Hs-2009-25-e-full.jpg')`});
$("#woodDisplay").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
$("#stoneDisplay").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
$("#scoreDisplay").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
$("#killCounter").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
function isElementVisible(e) {
    return (e.offsetParent !== null);
}
$("#foodDisplay").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
$("#allianceButton").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
$("#chatButton").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
$("#storeButton").css({background: `url('https://upload.wikimedia.org/wikipedia/commons/b/b2/Eagle_nebula_pillars.jpg')`});
document.getElementById("mainMenu").style.backgroundImage = "url(https://wgbh.brightspotcdn.com/dims4/default/986a887/2147483647/strip/true/crop/2000x1125+0+0/resize/2000x1125!/quality/70/?url=https%3A%2F%2Fimage.pbs.org%2Fcontentchannels%2F0McsXg0-show-mezzanine16x9-4PvNQjz.jpg)";

// ==UserScript==
// @name         This script makes everything better
// @namespace    This script makes everything better
// @version      2.2.1
// @match        *://*.moomoo.io/*
// @match        *://dev.moomoo.io/*
// @description  A few changes.
...
setInterval(() => {
setTimeout( () => {
document.getElementById('chatBox').placeholder = "Nova_CHAT";
setTimeout( () => {
document.getElementById('chatBox').placeholder = "No_a_C_AT";
setTimeout( () => {
document.getElementById('chatBox').placeholder = "_ova__H_T";
setTimeout( () => {
document.getElementById('chatBox').placeholder = "_o_a_C_A_";
}, 200);
}, 200);
}, 200);
}, 200);}
...
document.getElementById('loadingText').innerHTML = 'loading nova mod. stop screaming';
setTimeout( () => {
document.getElementById('loadingText').innerHTML = 'loading almost done.';
}, 400);
   500;

setInterval(() => {
document.getElementById('enterGame').innerHTML = 'LOST_IN_SPACE';
setTimeout( () => {
document.getElementById('enterGame').innerHTML = 'GO_TO_SPACE';
}, 400);}
 , 500);
...
setInterval(() => {
setTimeout( () => {
document.getElementById('nameInput').placeholder = "Slaxy Is Very Pro";
setTimeout( () => {
document.getElementById('nameInput').placeholder = "Nova Mod is OP";
}, 200);
}, 200);}
 , 500);
setInterval(() => {
setTimeout( () => {
document.getElementById('diedText').innerHTML = "You died. Sad";
setTimeout( () => {
document.getElementById('diedText').innerHTML = "But you are still pro";
}, 500);
}, 500);}
 , 800);
...
document.title = "Go FullScreen Pls";
// ==UserScript==
// @name         Moomoo.io Chat System
// @namespace    chat
// @version      0.1
// @description  Chat system from all Moomoo servers.
// @author       Magnet man
// @match        *://moomoo.io/*
// @match        *://sandbox.moomoo.io/*
// @match        *://dev.moomoo.io/*
...
<div style="font-size: 12px;">Press "C" to hide or show this box.<br>Just click below the "What is your nickname text",<br> type in a name and press enter!<br>This is chat from other people all across,<br>on all moomoo servers!</div>
</div>
`);
...
var YouName = window.prompt("Welcome to Nova Mod! Press OK to continue.");
